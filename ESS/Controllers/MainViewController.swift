...
class MainViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        showViewController(viewController: UINavigationController.self, storyboardId: "DashNavID")
    }
    ...
    func selectedCell(_ row: Int) {
        ...
        case 6:
            ...
            let storyboard = UIStoryboard(name: "Main", bundle: nil)
                ...
                let loginNavController = storyboard.instantiateViewController(identifier: "DashNavID")

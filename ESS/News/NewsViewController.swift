...
class NewsViewController: UIViewController {
    ...
    func initView() {
        // Navigation Bar
        UIHelper().setCustomNavigationTitle(title: "EmployeeNews", navItem: navigationItem)
...
extension NewsViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Date
        cell.dateLabel.text = currentPost.date?.iso8601Value()?.timeDate()
        // Source
...
extension NewsViewController: NSFetchedResultsControllerDelegate {
    ...
    func controller(_ controller: NSFetchedResultsController<NSFetchRequestResult>, didChange anObject: Any, at indexPath: IndexPath?, for type: NSFetchedResultsChangeType, newIndexPath: IndexPath?) {
        ...
        case .update:
            ...
            // Date
            cell.dateLabel.text = post.date?.iso8601Value()?.timeDate()
            // Source
